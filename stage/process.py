...
def __process_b(brick_new, brick_old):
    ...
    brick_new['bat_runtime_prediction'] = (None if ((brick_new['bat_charging'] or brick_new['bat_charging_standby']) and not brick_new['bat_solar_charging']) or brick_new.get('bat_wall_powered', False) else calculate_bat_prediction(brick_new))
